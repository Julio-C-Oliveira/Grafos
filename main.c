...
int main() {
    ...
    printf("\n");
    dfsCycleSearch_list(adjacentListGraphNaoEuleriano, startVertex);
    ...
    printf("\n");
    dfsCycleSearch_list(adjacentListGraphComCicloEuleriano, startVertex);
    ...
    printf("\n");
    dfsCycleSearch_list(adjacentListGraphComCaminhoEuleriano, startVertex);
